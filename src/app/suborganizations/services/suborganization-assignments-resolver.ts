...
@Injectable()
export class SuborganizationAssignmentsResolver implements Resolve<PositionAssignment[]> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<PositionAssignment[]> {
        ...
        return this.suborganizationService.getSuborganizationPositionAssignments(
            route.params['id'])
            .pipe(
